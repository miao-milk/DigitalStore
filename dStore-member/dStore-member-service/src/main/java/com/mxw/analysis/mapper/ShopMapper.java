...
public interface ShopMapper extends BaseMapper<ShopBuyerDO> {
    ...
    @Select("SELECT * from dStore_trade.buyer sb  LEFT JOIN shop_buyer_group  sbg ON sb.shop_buyer_id=sbg.shop_buyer_id WHERE sb.seller_id =#{sellerId} AND sbg.group_id=#{id}")
